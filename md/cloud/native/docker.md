...
11. 生成token，访问成功
12. 换电脑，k8s切换到v1.25.9
13. kubectl get nodes看到节点Ready
14. kubectl create deployment nginx --image=nginx
15. kubectl expose deployment nginx --port=80 --type=NodePort
16. kubectl get pod,svc
    1. NAME                 TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)        AGE
    2. service/kubernetes   ClusterIP   10.96.0.1      <none>        443/TCP        5h6m
    3. service/nginx        NodePort    10.109.57.64   <none>        80:32305/TCP   42s
17. 访问 192.168.2.157:32305，成功出现nginx界面
